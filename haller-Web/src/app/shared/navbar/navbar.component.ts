...
import { ROUTES, APPROUTES, ADMINAPPROUTES } from '../../sidebar/sidebar-routes.config';
...
export class NavbarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.listTitles = this.listTitles.concat(ADMINAPPROUTES.filter(listTitle => listTitle))
